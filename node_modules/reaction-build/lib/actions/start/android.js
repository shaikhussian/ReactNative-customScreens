    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            spinner = (0, _ora2.default)('starting android\n').start();
            _context2.next = 12;
          ...
          case 15:
            _context2.next = 17;
            return (0, _easycp.readcp)('which adb');
          ...
          case 17:
            ...
            _context2.next = 20;
            return (0, _easycp.silentcp)(`adb reverse tcp:8081 tcp:${config.ports.native}`);
          ...
          case 20:
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      (0, _easycp2.default)(`react-native run-android --port ${config.ports.native}`);
            ...
            _context2.next = 24;
            return (0, _easycp2.default)('react-native start --reset-cache');
