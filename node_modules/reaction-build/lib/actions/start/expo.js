    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            spinner = (0, _ora2.default)('starting expo\n').start();
            _context.next = 12;
          ...
          case 17:
            ...
            _context.next = 20;
            return (0, _easycp.silentcp)('adb reverse tcp:19000 tcp:19000');

          case 20:
            spinner.stop();
            _context.next = 23;
            return (0, _easycp2.default)(`exp start${options.offline ? ' --offline --localhost' : ''}`);
